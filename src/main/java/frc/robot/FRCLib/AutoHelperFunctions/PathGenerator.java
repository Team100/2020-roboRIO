...
public class PathGenerator {
    public static Command createAutoNavigationCommand(Drivetrain m_drivetrain,Pose2d start, List<Translation2d> waypoints, Pose2d end) {
        ...
        RamseteCommand ramseteCommand = new RamseteCommand(trajectory, m_drivetrain::getPose,
            new CustomRamseteController(Constants.DTConstants.RAMSETE_B, Constants.DTConstants.RAMSETE_ZETA),
