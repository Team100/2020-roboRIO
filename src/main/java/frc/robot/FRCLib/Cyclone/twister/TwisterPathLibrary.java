...
public class TwisterPathLibrary {
    ...
    public static TwisterPath crossField = new TwisterPath("Cross Field", new TwisterPoint[]{new TwisterPoint(10,0), new TwisterPoint(5, 0), new TwisterPoint (10,0), new TwisterPoint(5,0,180)});
}