...
public class TwisterPathLibrary {
    ...
    public static TwisterPath straightTwoMeters = new TwisterPath("Test Straight", new TwisterPoint[]{new TwisterPoint(0,0), new TwisterPoint(2,0)});
    ...
    public static TwisterPath sCurve = new TwisterPath("S Curve", new TwisterPoint[]{new TwisterPoint(0,0), new TwisterPoint(2,-1), new TwisterPoint(4, -2)});
}